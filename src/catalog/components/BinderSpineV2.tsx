// F50 · Wave 2.e · v2 · duplicado de BinderSpine.tsx. V1 queda intocada.
// Único cambio funcional vs v1: el círculo "guardar binder" es siempre
// visible al 100% de opacidad (self-evident signifier · Nielsen H6 +
// Norman Signifier). En v1 aparecía al 40% y solo llegaba a 100% con
// hover — lo que ocultaba la capacidad de guardar hasta que el usuario
// descubriera el hover accidentalmente.
//
    ...
    <div className="group/binder relative flex flex-col items-center hover:z-50">
      ...
      >
        ...
        >
          ...
          >
            {/* F50 · Wave 2.e · siempre al 100% de opacidad (era 40% + hover
                a 100%). El estado guardado/no-guardado se distingue por
                fill + check, no por opacidad. */}
            <span
