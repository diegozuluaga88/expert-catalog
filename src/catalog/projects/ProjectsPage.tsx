...
function ProjectCard({ project, onOpen, onRename, onDelete, onDuplicate, onDropProduct }: ProjectCardProps) {
    ...
    return (
        ...
        >
            ...
            {/* F57.1 · group-focus-within para que Tab en cualquier action
                revele el toolbar · antes destructive delete quedaba
                inalcanzable con teclado. */}
            <div className="flex items-center justify-end gap-0.5 border-t border-border bg-muted/30 px-2 py-1.5 opacity-0 transition-opacity group-hover:opacity-100 group-focus-within:opacity-100 [@media(hover:none)]:opacity-100">
